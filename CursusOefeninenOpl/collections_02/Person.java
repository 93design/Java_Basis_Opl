...
public class Person {
   ...
   public Person(String firstName, String lastName,
      GenderType gender, int age, float weight, float height) {
   ...
   public boolean equals(Object obj) {
      ...
      if (gender != other.gender)
         return false;
      if (Float.floatToIntBits(height) != Float.floatToIntBits(
         other.height))
         return false;
      if (lastName == null) {
         ...
         return false;
      if (Float.floatToIntBits(weight) != Float.floatToIntBits(
         other.weight))
         return false;
      return true;
   }
